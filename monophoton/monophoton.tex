...
\item we get one loose photon with \pt $ \ge 150 $ \GeV with a pseudorapidity cut in \etaRange{1.37}{1.52} to cut ot the calorimeter crack region and %\etaRange{2.37}
